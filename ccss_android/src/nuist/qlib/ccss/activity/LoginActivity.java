...
import nuist.qlib.ccss.adapter.KindRolesAdapter;
import nuist.qlib.ccss.adapter.RolesAdapter;
import nuist.qlib.ccss.dao.LoginDao;
import nuist.qlib.ccss.service.BroadcastIPService;
import nuist.qlib.ccss.service.ReceiveInforService;
	...
	private class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				case 1:
					dialogSubmit.dismiss();
					if (roleDes.equals("打分裁判")) {
						Intent intent = new Intent(LoginActivity.this,
								ScoreActivity.class);
						LoginActivity.this.startActivity(intent);
					} else if (roleDes.equals("裁判长")) {
						Intent intent = new Intent(LoginActivity.this,
								ViewActivity.class);
						LoginActivity.this.startActivity(intent);
					}
